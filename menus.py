...
class menu():
  ...
  def __init__(self, stats):
    self.menu = {'Start':['Play', 'Settings', 'Exit'], 'Play':['Difficulty', 'Nations', 'Start'],'Settings':['Start', 'Impossible Mode'], 'Exit':['debug'], 'debug':['Exit', 'Impossible Mode'], 'Impossible Mode':['debug'], 'Difficulty':['Easy', 'Medium', 'Hard'], 'Nations':['German Empire', 'British Empire', 'USA', 'France', 'Russian Empire', 'Japan', 'Ottoman Empire', 'Austro Hungarian Empire', 'Italy', 'Belgium', 'Luxembourg', 'Serbia', 'Montenegro'] 
    }
    self.stats = stats
    self.nation_list = {'German Empire':stats.german_empire, 'France':stats.france, 'USA':stats.USA, 'Japan':stats.japan, 'British Empire':stats.uk, 'Serbia':stats.serbia, 'Montenegro':stats.montenegro, 'A-H':stats.A_H, 'Ottoman Empire':stats.otto, 'Italy':stats.italy, 'Russian Empire':stats.russia, 'Belgium':stats.bel, 'Luxembourg':stats.lux}
